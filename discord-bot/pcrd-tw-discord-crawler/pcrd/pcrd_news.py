...
# https://shadow.softstargames.com.tw/news
...
def get_pcrd_news():
    ...
    # Crawler
    # r = requests.get("https://forum.gamer.com.tw/B.php?bsn=75993")
    ...
    for div in reversed(divObjects):
        ...
        # event_type = dtObjects[count].findAll("p", recursive=False)[0].get_text()
        ...
        if find_news == False:
            ...
            #     icon_url=
            #     'https://scontent.ftpe7-3.fna.fbcdn.net/v/t39.30808-1/385883702_157375…pe7-3.fna&oh=00_AfAawaKMjSCR_TlU7-Vf3Pt6qb0NS44fBZ2nTJtbESAduw&oe=6572FCF1'
            # )
